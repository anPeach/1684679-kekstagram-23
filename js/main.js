...
checkStringLength('Hello, my name is Nastya! But some people on the internet call me AnPeach.', MAX_STRING_LENGTH);
...
//когда происходит выполнение 71 строки - сервер виснет, на 68 строке - все нормально
